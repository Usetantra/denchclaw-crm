...
async function update(id, data, companyId) {
  ...
  const ALLOWED_CONTACT_COLUMNS = ['name','email','phone','company_name','company_ref_id','title','linkedin_url','source','lead_score','lead_score_numeric','deal_stage','marketing_stage','deal_value','tags','utm_source','utm_medium','utm_campaign','utm_content','metadata','last_contacted','next_follow_up','updated_at'];
