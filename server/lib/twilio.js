'use strict';
// ─── Twilio adapter ───────────────────────────────────────────────────────────
// Talks to Twilio's REST API on behalf of a company's connection. Accepts either
// Account SID + Auth Token, or Account SID + API Key SID/Secret (preferred). This
// module handles the "connect" verb (verify credentials, list numbers); sending /
// webhooks land in the provider phase and register through channel-adapter.
